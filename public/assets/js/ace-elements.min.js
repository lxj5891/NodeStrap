(function (b, c) {
  ...
  b.fn.ace_file_input = function (d) {
    var e = b.extend({style: false, no_file: "No File ...", no_icon: "icon-upload-alt", btn_choose: "Choose", btn_change: "Change", icon_remove: "icon-remove", droppable: false, thumbnail: false, before_change: null, before_remove: null}, d);
    ...
    this.each(function () {
      ...
      var h = function (x) {
        ...
        for (var v = 0; v < x.length; v++) {
          ...
          if (!q) {
            n.find("span").attr({"data-title": t}).find('[class*="icon-"]').attr("class", s)
          } else {
        ...
        s.onload = (function (y) {
          return function (z) {
            b(y).one("load", function () {
              ...
              b(y).css({"background-image": "url(" + B.src + ")", width: A, height: C}).attr({src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg=="}).show()
            });
      ...
      var g = function () {
        n.attr({"data-title": e.btn_choose, "class": ""}).find("span:first").attr({"data-title": e.no_file, "class": ""}).find('[class*="icon-"]').attr("class", e.no_icon).prev("img").remove();
        if (!e.no_icon) {
      ...
      var l = function (t, x, z) {
        ...
        return{src: u.toDataURL(z == "image/jpeg" ? z : "image/png", 10), w: s, h: y}
      }
    });
    return this
  }
...
(function (a, b) {
  a.fn.ace_colorpicker = function (c) {
    var d = a.extend({pull_right: false}, c);
    this.each(function () {
      var g = a(this);
      var e = "";
      var f = "";
      ...
      }).after('<div class="dropdown dropdown-colorpicker"><a data-toggle="dropdown" class="dropdown-toggle" href="#"><span class="btn-colorpicker" style="background-color:' + f + '"></span></a><ul class="dropdown-menu dropdown-caret' + (d.pull_right ? " pull-right" : "") + '">' + e + "</ul></div>").next().find(".dropdown-menu").on("click", function (j) {
        var h = a(j.target);
