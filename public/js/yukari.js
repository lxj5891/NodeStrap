...
var smart = {
  ...
  dopostData: function (url_, data_, callback_, progress_) {
    ...
    var self = this;
    $.ajax({
      url: url_ + "?_csrf=" + self.csrf(), type: "POST", async: true, data: data_, dataType: "json", contentType: false, processData: false, xhr: function () {
  ...
  dopost: function (url_, obj_, callback_) {
    ...
    var self = this;
    $.ajax({
      url: url_ , type: "POST", async: false, data: JSON.stringify(obj_), dataType: "json", contentType: "application/json", processData: false, success: function (result) {
  ...
  doput: function (url_, data_, callback_) {
    var self = this;
    $.ajax({
      url: url_ + "?_csrf=" + self.csrf(), type: "PUT", async: false, data: data_, success: function (result) {
  ...
  doget: function (url_, callback_) {
    $("#nsdialog").dialog();
    $.ajax({
      type: "GET", url: url_, dataType: "json",cache:false, success: function (result) {
        callback_(result.error, result);
        setTimeout(function () {
          try {
            $("#nsdialog").openOrClose("close");
          } catch (e) {
  ...
  pagination: function (container, totalItems, rowCount, callback) {
    ...
    container.unbind("click").on("click", "a", function (event) {
      ...
      container.append(_.template(tmpl, {
        "start": startPage, "limit": limit, "active": activePage, "canPrev": startPage > 1, "canNext": limit >= pageCount
      }));
